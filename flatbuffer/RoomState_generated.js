 ...
 * @constructor
 */
Neuralyzer.Transport.FlatBuffers.RoomState = function() {
  /**
   * @type {flatbuffers.ByteBuffer}
   */
  this.bb = null;
 ...
 * @param {number} i
 * @param {flatbuffers.ByteBuffer} bb
 * @returns {Neuralyzer.Transport.FlatBuffers.RoomState}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.prototype.__init = function(i, bb) {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param {flatbuffers.ByteBuffer} bb
 * @param {Neuralyzer.Transport.FlatBuffers.RoomState=} obj
 * @returns {Neuralyzer.Transport.FlatBuffers.RoomState}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.getRootAsRoomState = function(bb, obj) {
  return (obj || new Neuralyzer.Transport.FlatBuffers.RoomState).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns {string|Uint8Array|null}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.prototype.siteDrive = function(optionalEncoding) {
  var offset = this.bb.__offset(this.bb_pos, 4);
  return offset ? this.bb.__string(this.bb_pos + offset, optionalEncoding) : null;
};
 ...
 */
Neuralyzer.Transport.FlatBuffers.RoomState.prototype.poi = function(obj) {
  var offset = this.bb.__offset(this.bb_pos, 6);
 ...
 * @returns {Neuralyzer.Transport.FlatBuffers.Annotation}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.prototype.annotations = function(index, obj) {
  var offset = this.bb.__offset(this.bb_pos, 8);
 ...
 * @returns {number}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.prototype.annotationsLength = function() {
  var offset = this.bb.__offset(this.bb_pos, 8);
  return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
};
 ...
 * @returns {Neuralyzer.Transport.FlatBuffers.RoomObject}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.prototype.objects = function(index, obj) {
  var offset = this.bb.__offset(this.bb_pos, 10);
 ...
 * @returns {number}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.prototype.objectsLength = function() {
  var offset = this.bb.__offset(this.bb_pos, 10);
  return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
};
 ...
 * @param {flatbuffers.Builder} builder
 */
Neuralyzer.Transport.FlatBuffers.RoomState.startRoomState = function(builder) {
 ...
 */
Neuralyzer.Transport.FlatBuffers.RoomState.addSiteDrive = function(builder, siteDriveOffset) {
 ...
 */
Neuralyzer.Transport.FlatBuffers.RoomState.addPoi = function(builder, poiOffset) {
 ...
 */
Neuralyzer.Transport.FlatBuffers.RoomState.addAnnotations = function(builder, annotationsOffset) {
 ...
 * @returns {flatbuffers.Offset}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.createAnnotationsVector = function(builder, data) {
 ...
 * @param {number} numElems
 */
Neuralyzer.Transport.FlatBuffers.RoomState.startAnnotationsVector = function(builder, numElems) {
 ...
 */
Neuralyzer.Transport.FlatBuffers.RoomState.addObjects = function(builder, objectsOffset) {
 ...
 * @returns {flatbuffers.Offset}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.createObjectsVector = function(builder, data) {
  builder.startVector(4, data.length, 4);
  for (var i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]);
  }
 ...
 * @param {number} numElems
 */
Neuralyzer.Transport.FlatBuffers.RoomState.startObjectsVector = function(builder, numElems) {
  builder.startVector(4, numElems, 4);
};
 ...
 * @returns {flatbuffers.Offset}
 */
Neuralyzer.Transport.FlatBuffers.RoomState.endRoomState = function(builder) {
  var offset = builder.endObject();
  return offset;
};
 ...
 */
Neuralyzer.Transport.FlatBuffers.RoomState.finishRoomStateBuffer = function(builder, offset) {
