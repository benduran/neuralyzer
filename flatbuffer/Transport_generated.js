 ...
 * @enum
 */
Neuralyzer.Transport.FlatBuffers.msgType = {
  RoomStateUpdate: 0,
  SocketReady: 1,
  SocketRoomJoined: 2,
  RoomCreated: 3,
 ...
 * @enum
 */
Neuralyzer.Transport.FlatBuffers.msg = {
  NONE: 0,
  StateUpdate: 1,
  StringData: 2,
  JoinCreateRequest: 3
 ...
 * @constructor
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage = function() {
  /**
   * @type {flatbuffers.ByteBuffer}
   */
  this.bb = null;
 ...
 * @param {number} i
 * @param {flatbuffers.ByteBuffer} bb
 * @returns {Neuralyzer.Transport.FlatBuffers.ServerMessage}
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.prototype.__init = function(i, bb) {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param {flatbuffers.ByteBuffer} bb
 * @param {Neuralyzer.Transport.FlatBuffers.ServerMessage=} obj
 * @returns {Neuralyzer.Transport.FlatBuffers.ServerMessage}
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.getRootAsServerMessage = function(bb, obj) {
  return (obj || new Neuralyzer.Transport.FlatBuffers.ServerMessage).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};

/**
 * @returns {Neuralyzer.Transport.FlatBuffers.msgType}
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.prototype.type = function() {
  var offset = this.bb.__offset(this.bb_pos, 4);
  return offset ? /** @type {Neuralyzer.Transport.FlatBuffers.msgType} */ (this.bb.readInt8(this.bb_pos + offset)) : Neuralyzer.Transport.FlatBuffers.msgType.RoomStateUpdate;
};

/**
 * @returns {Neuralyzer.Transport.FlatBuffers.msg}
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.prototype.dataType = function() {
  var offset = this.bb.__offset(this.bb_pos, 6);
  return offset ? /** @type {Neuralyzer.Transport.FlatBuffers.msg} */ (this.bb.readUint8(this.bb_pos + offset)) : Neuralyzer.Transport.FlatBuffers.msg.NONE;
};
 ...
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.prototype.data = function(obj) {
  var offset = this.bb.__offset(this.bb_pos, 8);
 ...
 * @param {flatbuffers.Builder} builder
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.startServerMessage = function(builder) {
  builder.startObject(3);
};

/**
 * @param {flatbuffers.Builder} builder
 * @param {Neuralyzer.Transport.FlatBuffers.msgType} type
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.addType = function(builder, type) {
  builder.addFieldInt8(0, type, Neuralyzer.Transport.FlatBuffers.msgType.RoomStateUpdate);
};

/**
 * @param {flatbuffers.Builder} builder
 * @param {Neuralyzer.Transport.FlatBuffers.msg} dataType
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.addDataType = function(builder, dataType) {
  builder.addFieldInt8(1, dataType, Neuralyzer.Transport.FlatBuffers.msg.NONE);
};
 ...
 * @param {flatbuffers.Offset} dataOffset
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.addData = function(builder, dataOffset) {
 ...
 * @returns {flatbuffers.Offset}
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.endServerMessage = function(builder) {
  var offset = builder.endObject();
  return offset;
};
 ...
 */
Neuralyzer.Transport.FlatBuffers.ServerMessage.finishServerMessageBuffer = function(builder, offset) {
